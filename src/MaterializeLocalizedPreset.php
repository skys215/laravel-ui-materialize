...
class MaterializeLocalizedPreset extends Preset
{
    /** @var Command */
    protected $command;
    ...
    {
        copy(__DIR__.'/../materialize-stubs/bootstrap/webpack.mix.js', base_path('webpack.mix.js'));
    }
    ...
    protected static function updateSass()
    {
        ...
        copy(__DIR__.'/../materialize-stubs/bootstrap/_variables.scss', resource_path('sass/_variables.scss'));
        copy(__DIR__.'/../materialize-stubs/bootstrap/app.scss', resource_path('sass/app.scss'));
    }
    ...
    {
        copy(__DIR__.'/../materialize-stubs/bootstrap/bootstrap.js', resource_path('js/bootstrap.js'));
        copy(__DIR__.'/../materialize-stubs/bootstrap/app.js', resource_path('js/app.js'));
    }
    ...
    protected function scaffoldAuth()
    {
        ...
        tap(new Filesystem(), function ($filesystem) {
            $filesystem->copyDirectory(__DIR__.'/../materialize-stubs/auth-localized', resource_path('views/auth'));
            $filesystem->copyDirectory(__DIR__.'/../materialize-stubs/layouts-localized', resource_path('views/layouts'));
            $filesystem->copy(__DIR__.'/../materialize-stubs/home-localized.blade.php', resource_path('views/home.blade.php'));
