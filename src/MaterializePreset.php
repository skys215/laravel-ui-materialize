...
class MaterializePreset extends Preset
{
    ...
    protected function scaffoldAuth()
    {
        ...
        tap(new Filesystem(), function ($filesystem) {
            $filesystem->copyDirectory(__DIR__.'/../materialize-stubs/auth', resource_path('views/auth'));
            $filesystem->copyDirectory(__DIR__.'/../materialize-stubs/layouts', resource_path('views/layouts'));
            $filesystem->copy(__DIR__.'/../materialize-stubs/home.blade.php', resource_path('views/home.blade.php'));
